package com.pos.sdkdemo.cards.M1Desfirecard;
...
/**
 * M1 Desfire卡 (M1 Desfire Card)
 */
public class M1DesfireCard extends BaseActivity {
        ...
        if (v != null) {
            ...
            start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        LOGD("detect M1 Desfire card ...");
                        cardService =  ServiceManager.getInstence().getCard();
                        cardService.openM1DesfireAndDetect(60 * 1000, new OnDetectListener() {
                            @Override
                            public void onSuccess(int i) {
                                LOGD("detect M1 Desfire card success!");
                                showCardInfo(i);
