...
//                    showResult("Encrypted password:" + new String(bytes));
            ...
            switch (pinpad_version)
            {
                case PinpadInterfaceVersion.PINPAD_INTERFACE_VERSION1:
                    LogUtil.i(getClass(),"enter pinpad interface version 1.0");
                    ServiceManager.getInstence().getPinpad().inputOnlinePin(cardNumber, new byte[]{0, 6});
                    break;
                case PinpadInterfaceVersion.PINPAD_INTERFACE_VERSION2:
                    LogUtil.i(getClass(),"enter pinpad interface version 2.0");
                    ServiceManager.getInstence().getPinpad().inputOnlinePinNew(tmkindex,cardNumber, new byte[]{0, 6});
                    break;
                ...
                case PinpadInterfaceVersion.PINPAD_INTERFACE_DUKPT:
                    ...
                    ServiceManager.getInstence().getPinpad().inputOnlinePinDukpt(1, 0, 60, cardNumber, new byte[]{0, 6});
                    break;  	
            }
